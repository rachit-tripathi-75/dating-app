...
public class BalanceActivity extends ActivityBase {
    ...
    static final String ITEM_SKU_1 = "chaska.deificdigital.com.iap1";            // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "chaska.deificdigital.com.iap2";            // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "chaska.deificdigital.com.iap3";            // Change to: yourdomain.com.iap3
