    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                Toast.makeText(getActivity(), getString(R.string.otp_verification_code_sent_msg), Toast.LENGTH_SHORT).show();
                updateUI();
            }
        };
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(getActivity(), getString(R.string.otp_verification_code_error_msg), Toast.LENGTH_SHORT).show();
                            }
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    if (response.has("error_code")) {
                                        ...
                                        if (error_code == ERROR_OTP_PHONE_NUMBER_TAKEN) {
                                            ...
                                            Toast.makeText(getActivity(), getString(R.string.otp_verification_phone_number_taken_error_msg), Toast.LENGTH_SHORT).show();

                                            mVerificationInProgress = false;

                                        } else {

                                            Toast.makeText(getActivity(), getString(R.string.otp_verification_error_msg), Toast.LENGTH_SHORT).show();
                                        }
                                    }
