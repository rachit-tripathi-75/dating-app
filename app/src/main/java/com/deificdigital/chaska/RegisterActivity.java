...
public class RegisterActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigator = findViewById(R.id.navigator_layout);
    ...
    public void setStatusBarColor(AppCompatActivity act, int index) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            switch (index) {
                ...
                case 0: {
                    ...
                    window.setStatusBarColor(getColorWrapper(act, R.color.colorPrimaryDark));
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            switch (position) {
                ...
                case 0: {
                    ...
                    mReferrer = view.findViewById(R.id.referrer_edit);
                    ...
                    mFacebookAuthContainer = view.findViewById(R.id.facebook_auth_container);
                    mOauthTypeLabel = view.findViewById(R.id.labelAuthorizationViaFacebook);

                    mFacebookAuth = view.findViewById(R.id.button_facebook_login);
                    ...
                    mButtonRegularAuth = view.findViewById(R.id.button_regular_auth);
                    mButtonTerms = view.findViewById(R.id.button_terms);

                    mButtonContinue = view.findViewById(R.id.button_continue);
                ...
                case 3: {
                    ...
                    mButtonChooseSexOrientation = view.findViewById(R.id.button_choose_sexual_orientation);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    ...
                    default: {
                        ...
                        Helper helper = new Helper(RegisterActivity.this);
