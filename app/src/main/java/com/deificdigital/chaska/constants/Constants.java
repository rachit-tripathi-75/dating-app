package com.deificdigital.chaska.constants;
...
public interface Constants {
    ...
    int VIDEO_FILE_MAX_SIZE = 31457280; //Max size for video file in bytes | For example 5mb = 5*1024*1024

    String WEB_SITE = "https://datingnet.xyz/";  //web site url address
    ...
    String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA06dhoysip7K";
    ...
    String API_DOMAIN = "  https://datoo.deificindia.com/";  // url address to which the application sends requests | with back slash "/" at the end | example: https://mysite.com/ | for emulator on localhost: http://10.0.2.2/
    ...
    String METHOD_CHAT_SPAM = API_DOMAIN + "api/" + API_VERSION + "/method/chat.spam" + API_FILE_EXTENSION;

    int SEARCH_DISTANCE_DEFAULT = 30000;
    int HOTGAME_DISTANCE_DEFAULT = 30000;
