package com.deificdigital.chaska.model;
...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int photoModerateAt = 0, coverModerateAt = 0;
    ...
    public Profile(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                if (jsonData.has("coverModerateAt")) {

                    this.setCoverModerateAt(jsonData.getInt("coverModerateAt"));
                }
    ...
    public void setNormalPhotoUrl(String normalPhotoUrl) {
        ...
        if (API_DOMAIN.equals("http://10.0.2.2/")) {
            ...
            this.normalPhotoUrl = normalPhotoUrl.replace("http://localhost/","http://10.0.2.2/");
    ...
    public void setCoverModerateAt(int coverModerateAt) {

        this.coverModerateAt = coverModerateAt;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.coverModerateAt);
        dest.writeInt(this.otpVerified);
    }
    ...
    protected Profile(Parcel in) {
        ...
        this.coverModerateAt = in.readInt();
        this.otpVerified = in.readInt();
    }
